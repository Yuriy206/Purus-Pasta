...
public class Slotted extends Tip {
	...
	public void layout(Layout var1) {
		...
		if (this.attrs.length > 0) {
			...
			var2 = RichText.render(String.format(chanceStr, "192,192,255", Long.valueOf(Math.round(100.0D * this.pmin)),
					"192,192,255", Long.valueOf(Math.round(100.0D * this.pmax))), 0, new Object[0]).img;
			...
			for (int var6 = 0; var6 < this.attrs.length; ++var6) {
				BufferedImage var7 = PUtils.convolvedown(((Image) this.attrs[var6].layer(Resource.imgc)).img,
			...
			var2 = RichText.render(
					String.format(chanceStr, "192,192,255", Integer.valueOf((int) Math.round(100.0D * this.pmin))), 0,
					new Object[0]).img;
