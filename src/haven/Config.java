...
public class Config {
	...
	public final static Set<String> foragables = new HashSet<String>(Arrays.asList("gfx/terobjs/herbs/flotsam",
			...
			"gfx/terobjs/herbs/glimmermoss", "gfx/terobjs/herbs/camomile", "gfx/terobjs/herbs/clay-cave"));

	public final static Set<String> locres = new HashSet<String>(
			Arrays.asList("gfx/terobjs/saltbasin", "gfx/terobjs/abyssalchasm", "gfx/terobjs/windthrow",
					"gfx/terobjs/icespire", "gfx/terobjs/woodheart", "gfx/terobjs/jotunmussel", "gfx/terobjs/guanopile",
					"gfx/terobjs/geyser", "gfx/terobjs/claypit", "gfx/terobjs/caveorgan", "gfx/terobjs/crystalpatch"));

	public final static Set<String> mineablesStone = new HashSet<String>(
			Arrays.asList("gneiss", "basalt", "cinnabar", "dolomite", "feldspar", "flint", "granite", "hornblende",
					"limestone", "marble", "porphyry", "quartz", "sandstone", "schist", "blackcoal"));

	public final static Set<String> mineablesOre = new HashSet<String>(
			Arrays.asList("cassiterite", "chalcopyrite", "malachite", "ilmenite", "limonite", "hematite", "magnetite"));

	public final static Set<String> mineablesOrePrecious = new HashSet<String>(
			Arrays.asList("galena", "argentite", "hornsilver", "petzite", "sylvanite", "nagyagite"));

	public final static Set<String> mineablesCurios =
			new HashSet<String>(Arrays.asList("catgold", "petrifiedshell", "strangecrystal"));
	...
	public final static HashMap<String, String[]> cures = new HashMap<String, String[]>(18) {
		{
			put("paginae/wound/antburn", new String[] { "gfx/invobjs/herbs/yarrow" });
			put("paginae/wound/blunttrauma",
					new String[] { "gfx/invobjs/toadbutter", "gfx/invobjs/leech", "gfx/invobjs/gauze",
							"gfx/invobjs/hartshornsalve", "gfx/invobjs/camomilecompress", "gfx/invobjs/opium" });
			put("paginae/wound/bruise", new String[] { "gfx/invobjs/leech" });
			put("paginae/wound/concussion", new String[] { "gfx/invobjs/coldcompress", "gfx/invobjs/opium" });
			put("paginae/wound/cruelincision",
					new String[] { "gfx/invobjs/gauze", "gfx/invobjs/stitchpatch", "gfx/invobjs/rootfill" });
			put("paginae/wound/deepcut", new String[] { "gfx/invobjs/gauze", "gfx/invobjs/stingingpoultice",
					"gfx/invobjs/rootfill", "gfx/invobjs/herbs/waybroad" });
			put("paginae/wound/fellslash", new String[] { "gfx/invobjs/gauze" });
			put("paginae/wound/nicksnknacks", new String[] { "gfx/invobjs/herbs/yarrow" });
			put("paginae/wound/punchsore", new String[] { "gfx/invobjs/mudointment", "gfx/invobjs/opium" });
			put("paginae/wound/scrapesncuts", new String[] { "gfx/invobjs/herbs/yarrow", "gfx/invobjs/mudointment" });
			put("paginae/wound/severemauling", new String[] { "gfx/invobjs/hartshornsalve" });
			put("paginae/wound/swollenbump",
					new String[] { "gfx/invobjs/coldcompress", "gfx/invobjs/leech", "gfx/invobjs/stingingpoultice" });
			put("paginae/wound/unfaced",
					new String[] { "gfx/invobjs/toadbutter", "gfx/invobjs/leech", "gfx/invobjs/mudointment" });
			put("paginae/wound/wretchedgore", new String[] { "gfx/invobjs/stitchpatch", "gfx/invobjs/opium" });
			put("paginae/wound/blackeye", new String[] { "gfx/invobjs/hartshornsalve", "gfx/invobjs/toadbutter" });
			put("paginae/wound/bladekiss", new String[] { "gfx/invobjs/gauze", "gfx/invobjs/toadbutter" });
			put("paginae/wound/somethingbroken", new String[] { "gfx/invobjs/camomilecompress" });
			put("paginae/wound/infectedsore",
					new String[] { "gfx/invobjs/camomilecompress", "gfx/invobjs/soapbar", "gfx/invobjs/opium" });
		}
	};
