...
public class RenderedNormals extends FBConfig.RenderTarget {
	...
	public static final GLState.Slot<GLState> slot =
			new GLState.Slot<GLState>(GLState.Slot.Type.SYS, GLState.class, GLFrameBuffer.slot, States.presdepth.slot);
	...
	public static final PView.RenderContext.DataID<RenderedNormals> id =
			new PView.RenderContext.DataID<RenderedNormals>() {
