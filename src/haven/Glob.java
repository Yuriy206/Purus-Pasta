...
public class Glob {
				...
				public boolean hasNext() {
					if (n == null) {
						while (true) {
							...
							Class<? extends Weather> cl =
									cur.getKey().get().layer(Resource.CodeEntry.class).getcl(Weather.class);
							Weather w;
							try {
	...
	/*
	 * XXX: This is actually quite ugly and there should be a better way, but
	 * until I can think of such a way, have this as a known entry-point to be
