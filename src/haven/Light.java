...
public class Light implements Rendered {
	...
	public static final GLState.Slot<LightList> lights =
			new GLState.Slot<LightList>(GLState.Slot.Type.SYS, LightList.class, PView.cam);
	public static final GLState.Slot<Model> model =
			new GLState.Slot<Model>(GLState.Slot.Type.DRAW, Model.class, PView.proj);
	public static final GLState.Slot<GLState> lighting =
			new GLState.Slot<GLState>(GLState.Slot.Type.DRAW, GLState.class, model, lights);
