...
public class FastMesh implements FRendered, Rendered.Instanced, Disposable {
	...
	public abstract class Compiler {
		...
		private Object[] getid(GOut g) {
			...
			/*
			 * XXX: Probably, each auto-inst should have to be ID'd in some
			 * meaningful way, but I'm not currently sure what would consitute a
			 * proper ID.
			 */
	...
	/*
	 * XXX: One might start to question if it isn't about time to dispose of
