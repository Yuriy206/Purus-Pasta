...
public class SNoise3 {
	...
	public double get(double r, double x, double y, double z) {
		...
		double[] g0 =
				gtab[((int) ptab[(int) (ip + ptab[(int) (jp + ptab[(int) kp & 0xff]) & 0xff]) & 0xff] & 0xff) % 12];
		double[] g1 =
				gtab[((int) ptab[(int) (ip + i1 + ptab[(int) (jp + j1 + ptab[(int) (kp + k1) & 0xff]) & 0xff]) & 0xff]
						& 0xff) % 12];
		double[] g2 =
				gtab[((int) ptab[(int) (ip + i2 + ptab[(int) (jp + j2 + ptab[(int) (kp + k2) & 0xff]) & 0xff]) & 0xff]
						& 0xff) % 12];
		double[] g3 =
				gtab[((int) ptab[(int) (ip + 1 + ptab[(int) (jp + 1 + ptab[(int) (kp + 1) & 0xff]) & 0xff]) & 0xff]
						& 0xff) % 12];
