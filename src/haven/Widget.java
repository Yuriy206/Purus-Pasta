...
public class Widget {
	...
	public static class FactMaker implements Resource.PublishedCode.Instancer {
		public Factory make(Class<?> cl) throws InstantiationException, IllegalAccessException {
			...
			try {
				...
				if (Widget.class.isAssignableFrom(mkm.getReturnType()) && ((mod & Modifier.STATIC) != 0)
	...
	public static Factory gettype(String name) {
		...
		try {
			...
			throw (new RuntimeException(
					"Interrupted while loading resource widget (took " + (System.currentTimeMillis() - start) + " ms)",
					e));
		}
		if (f == null)
	...
	public void wdgmsg(Widget sender, String msg, Object... args) {
		if (msg.equals("click") && args.length >= 5
				&& ui.sess.glob.oc.getgob(Long.valueOf((int) args[5])).getres().name.contains("steelcrucible")
				&& (int) args[3] == 1) {
			return;
		}
		if (parent == null)
