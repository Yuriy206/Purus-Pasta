...
public class GobHitbox extends Sprite {
	public static States.ColState fillclrstate =
	...
	private static final BBox[] bboxBumlings = new BBox[] { new BBox(new Coord(-1, -1), new Coord(1, 1)),
			new BBox(new Coord(-2, -2), new Coord(2, 2)), new BBox(new Coord(-3, -3), new Coord(3, 3)),
			new BBox(new Coord(-4, -4), new Coord(4, 4)), new BBox(new Coord(-5, -5), new Coord(5, 5)) };
	...
	public static BBox getBBox(Gob gob, boolean fix) {
		...
		// or some negs simply have wrong Y dimensions. in either case this
		// fixes it
		if (fix) {
