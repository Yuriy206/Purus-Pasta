...
public abstract class States extends GLState {
	...
	public static final Slot<DepthOffset> depthoffset =
			new Slot<DepthOffset>(Slot.Type.GEOM, DepthOffset.class, PView.proj);
	...
	public static class PolygonMode extends GLState {
		public static final Slot<PolygonMode> slot =
				new Slot<PolygonMode>(Slot.Type.GEOM, PolygonMode.class, PView.proj);
		public final int mode;
